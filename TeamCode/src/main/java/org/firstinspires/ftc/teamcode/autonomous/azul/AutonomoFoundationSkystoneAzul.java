...
public class AutonomoFoundationSkystoneAzul extends IMUPIDEncoderHolonomicLinearOpMode { //extendemos una clase que ya contiene todos los metodos de encoders y IMU para optimizar el codigo y el tiempo
    //Daniel es un otaku
    public Hardware hdw;
