...
@Autonomous(name="Autonomo 90 degrees P repeat", group="Test")
public class Autonomo90degreesP extends IMUPIDHolonomicLinearOpMode { //extendemos una clase que ya contiene todos los metodos de encoders y IMU para optimizar el codigo y el tiempo
