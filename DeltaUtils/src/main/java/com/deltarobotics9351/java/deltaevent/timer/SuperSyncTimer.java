...
package com.deltarobotics9351.java.deltaevent.timer;

import com.deltarobotics9351.java.DeltaAppUtil;
import com.deltarobotics9351.java.deltaevent.Super;
import com.deltarobotics9351.java.deltaevent.event.Event;
import com.deltarobotics9351.java.deltaevent.event.manager.AsyncTimersManager;
import com.deltarobotics9351.java.deltaevent.event.timer.TimerEvent;
...
import static com.deltarobotics9351.java.AsyncUtil.asyncExecute;
...
public class SuperSyncTimer implements Super {
    ...
    public final void destroy() {
        ...
        if(this instanceof SuperAsyncTimer) AsyncTimersManager.removeAsyncTimer((SuperAsyncTimer) this);
